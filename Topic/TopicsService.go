...
func (T * TopicService) setGorm(db *gorm.DB){
	T.DB =  db
}

func ( N * TopicService ) Get(res http.ResponseWriter, req *http.Request){
	var  _topic TopicsData
   _topics := []TopicsData{}
...
func ( T * TopicService ) GetDeletedTopcis(res http.ResponseWriter, req *http.Request){
    var  _topic TopicsData
   _topics := []TopicsData{}
   errParseURl := decoder.Decode(&_topic, req.URL.Query())
   if errParseURl != nil  {
...
func (T *TopicService)Create(res http.ResponseWriter, req *http.Request){
	decoder := json.NewDecoder(req.Body)
	var _topics TopicsData
...
func (T *TopicService)Update(res http.ResponseWriter, req *http.Request){
...
func (T *TopicService)Delete(res http.ResponseWriter, req *http.Request){
	var _topics TopicsData
	var id = req.URL.Query().Get("id")
	_id, err := strconv.Atoi(id)
	err = GetTopics(T.DB, _id , &_topics)
